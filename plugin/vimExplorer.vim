...
let VEConf.filePanelHotkey.goAndOpen       = 'o'
...
function! VEConf_singleFileActions['openItem'](path)
    if !isdirectory(a:path)
        exec "tabe " . g:VEPlatform.escape(a:path)
    else
        call VE_OnFileItemClick()
    endif
endfunction
...
function! s:VEFilePanel.createActions()
    ...
    exec "nnoremap <silent> <buffer> " . g:VEConf.filePanelHotkey.goAndOpen .      " gg :call VE_SingleFileAction(\"openItem\")<cr>"
