...
call s:initVariable("g:NERDTreeMapGoAndActivateNode", "l")
call s:initVariable("g:NERDTreeMapQuitAndActivateNode", "L")
...
call s:initVariable("g:NERDTreeMapStayAndActivate", "g" . NERDTreeMapGoAndActivateNode)
...
function! s:bindMappings()
    ...
    exec "nnoremap <silent> <buffer> ". g:NERDTreeMapGoAndActivateNode . " gg :call <SID>activateNode(0)<cr>"
    ...
    exec "nnoremap <silent> <buffer> ". g:NERDTreeMapStayAndActivate ." gg :call <SID>previewNode(0)<cr>"
    exec "nnoremap <silent> <buffer> ". g:NERDTreeMapQuitAndActivateNode ." gg :call <SID>previewNode(0)<cr> :q<cr>"
